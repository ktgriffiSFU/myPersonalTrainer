...
@interface TrainerProfileViewController ()<MFMailComposeViewControllerDelegate>
@end
...
@synthesize trainerSummary,trainerPic,trainerEmail,trainerName,rowNumber;
...
-(void) createViews{
    ...
    [button1 setTitle:@"INQUIRE" forState:UIControlStateNormal];
